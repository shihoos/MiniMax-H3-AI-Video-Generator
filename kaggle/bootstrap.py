...
def install_embedded_context_ir_node() -> None:
    ...
    print("[NODE] embedded ComfyUI-MiniMax-H3-ContextIR")
...
def main():
    ...
    install_nodes()
    install_embedded_context_ir_node()
